...
export default function Hatinfo(props) {
  ...
  return (
    <div className="hat-info">
      ...
      {/* {props !== "NORMAL" ? <div className='info-box'><img className='hat-info' src={require('./img/' + props + 'info.png')} alt='info'></img></div> : null} */}
      <div className='info-box'><img className='hat-info' src={require('./img/REDinfo.png')} alt='info'></img></div>
    </div>
  );
